<?php
    ...
    if (isset($_POST["add-student"])) {
        ...
        $query = "SELECT `AUTO_INCREMENT` FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'attendance' AND TABLE_NAME = 'users_all'";
        ...
        $success = mysqli_fetch_assoc(mysqli_query($connect, "SELECT `success` FROM `esp_edu_state`"))["success"];
        echo $success;
    ...
    if (isset($_POST["remove-student"])) {
        ...
        echo mysqli_fetch_assoc(mysqli_query($connect, "SELECT `success` FROM `esp_edu_state`"))["success"];
        mysqli_query($connect, "DELETE FROM `esp_edu_state`");
        exit(0);
    }
    // ==========================================================================================================
    ...
    if (isset($_POST["update-fingerprint"])){
        $filterData = filteration($_POST);
